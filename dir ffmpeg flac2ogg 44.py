...
to .ogg files, 41.1 kHz, 16 bit, in selected folder, recursively,
...
Run::
    ...
    python "ffmpeg flac2ogg 44.py" "target_name"

to open in "target_name" dir, or add::

    pythonw.exe "ffmpeg flac2ogg 44.py" "%1"
...
# ↓ Creating dialog
sortir = Tk()
sortir.title('flac2ogg 44.1 kHz 16 bit')
